...
declare module '@bootstrap-styled/provider' {
    ...
    export const UtilityProvider: StyledComponentBase<'div', StyledTheme, UtilityProviderProps>

    class BootstrapProvider extends Component<BootstrapProviderProps, BootstrapProviderState> {
        private setTheme: (userTheme: { theme: UserTheme }, callback?: function) => void
...
declare module '@bootstrap-styled/utils' {
    ...
    export class UnitUtils {
        ...
        public toPercent: (value: number, total?: number, decimal?: number) => string
    }
...
declare module '@bootstrap-styled/css-utils' {
    ...
    export const positionUtils: {
        ...
        getPositionUtilities: (zindexFixed?: string, zindexSticky?: string) => string
    ...
    export const transitionUtils: {
        ...
        getReactTransition: (enableTransitions: boolean, transition: string) => string
        fade: (enableTransitions?: boolean, transitionFade?: string) => string
        collapse: (enableTransitions?: boolean, transitionCollapse?: string) => string
    }
...
declare module 'bootstrap-styled' {
    import { getGlobalStyles, getGlobalStyleNoBootstrapProvider } from '@bootstrap-styled/css-utils'
    ...
    export function toMakeTheme(theme: AnyTheme): (userTheme: Partial<AnyTheme>) => AnyTheme
}
...
declare module '@bootstrap-styled/v4' {
    ...
    export const A: StyledComponentBase<ComponentClass<AProps, { focus: boolean }>, StyledTheme>
    ...
    export const Link: StyledComponentBase<ComponentClass<LinkProps>, StyledTheme>

    export const composeLink: (
        RouterLink: ComponentType<{ className?: string; to: string } & HTMLAttributes<HTMLElement>>
    ) => typeof Link
    ...
    export const Abbr: StyledComponentBase<ComponentClass<AbbrProps>, StyledTheme>
    ...
    export const Article: StyledComponentBase<FunctionComponent<ArticleProps>, StyledTheme>
    ...
    export const Blockquote: StyledComponentBase<ComponentClass<BlockquoteProps>, StyledTheme>
    ...
    export const Breadcrumb: StyledComponentBase<ComponentClass<BreadcrumbProps>, StyledTheme>
    ...
    export type ButtonProps = {
        ...
        outline?: boolean
        className?: string
        color?: 'link' | 'primary' | 'secondary' | 'success' | 'info' | 'warning' | 'danger'
        ref?: Function
        onClick?: Function
    ...
    export const Button: StyledComponentBase<ComponentClass<ButtonProps>, StyledTheme>
    ...
    export const ButtonGroup: StyledComponentBase<ComponentClass<ButtonGroupProps>, StyledTheme>
    ...
    export const ButtonToolbar: StyledComponentBase<ComponentClass<ButtonToolbarProps>, StyledTheme>
    ...
    export const Caption: StyledComponentBase<FunctionComponent<CaptionProps>, StyledTheme>
    ...
    export const Close: StyledComponentBase<ComponentClass<CloseProps>, StyledTheme>
    ...
    export const Code: StyledComponentBase<ComponentClass<CodeProps>, StyledTheme>
    ...
    export const Details: StyledComponentBase<FunctionComponent<DetailsProps>, StyledTheme>
    ...
    export const Drawer: StyledComponentBase<ComponentClass<DrawerProps>, StyledTheme>
    ...
    export const Fieldset: StyledComponentBase<'fieldset', StyledTheme, FieldsetProps>

    export type FooterProps = HTMLAttributes<HTMLElement>

    export const Footer: StyledComponentBase<FunctionComponent<FooterProps>, StyledTheme>
    ...
    export const Figure: StyledComponentBase<ComponentClass<FigureProps>, StyledTheme>
    ...
    export const FigCaption: StyledComponentBase<ComponentClass<FigCaptionProps>, StyledTheme>
    ...
    export const Input: StyledComponentBase<ComponentClass<InputProps>, StyledTheme>
    ...
    export const InputGroup: StyledComponentBase<ComponentClass<InputGroupProps>, StyledTheme>
    ...
    export const Jumbotron: StyledComponentBase<ComponentClass<JumbotronProps>, StyledTheme>
    ...
    export const Label: StyledComponentBase<FunctionComponent<LabelProps>, StyledTheme>
    ...
    export const ListGroup: StyledComponentBase<ComponentClass<ListGroupProps>, StyledTheme>
    ...
    export const Media: StyledComponentBase<ComponentClass<MediaProps>, StyledTheme>
    ...
    export const Modal: StyledComponentBase<ComponentClass<ModalProps>, StyledTheme>
    ...
    export const ModalHeader: StyledComponentBase<ComponentClass<ModalHeaderProps>, StyledTheme>
    ...
    export const Output: StyledComponentBase<ComponentClass<OutputProps>, StyledTheme>
    ...
    export const Pagination: StyledComponentBase<ComponentClass<PaginationProps>, StyledTheme>
    ...
    export const Progress: StyledComponentBase<ComponentClass<ProgressProps>, StyledTheme>
    ...
    export const Select: StyledComponentBase<ComponentClass<SelectProps>, StyledTheme>
    ...
    export const Small: StyledComponentBase<ComponentClass<SmallProps>, StyledTheme>
    ...
    export const Strong: StyledComponentBase<ComponentClass<StrongProps>, StyledTheme>
    ...
    export const Table: StyledComponentBase<ComponentClass<TableProps>, StyledTheme>
    ...
    export const Badge: StyledComponentBase<ComponentClass<BadgeProps>, StyledTheme>
    ...
    export const Tooltip: StyledComponentBase<ComponentClass<TooltipProps>, StyledTheme>
    ...
    export const Card: StyledComponentBase<ComponentClass<CardProps>, StyledTheme>
    ...
    export const CardColumns: StyledComponentBase<ComponentClass<CardColumnsProps>, StyledTheme>
    ...
    export const CardDeck: StyledComponentBase<ComponentClass<CardDeckProps>, StyledTheme>
    ...
    export const CardGroup: StyledComponentBase<ComponentClass<CardGroupProps>, StyledTheme>
    ...
    export const Dropdown: StyledComponentBase<ComponentClass<DropdownProps>, StyledTheme>
    ...
    export const Form: StyledComponentBase<ComponentClass<FormProps>, StyledTheme>
    ...
    export const Navbar: StyledComponentBase<ComponentClass<NavbarProps>, StyledTheme>
    ...
    export const Container: StyledComponentBase<ComponentClass<ContainerProps>, StyledTheme>
}
